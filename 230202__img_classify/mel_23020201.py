...
Original file is located at
    https://colab.research.google.com/drive/1JKR216B0zAFyDsrMKXs3j6O9T0rW6RgQ
"""
...
save_model_path = "./melmodel3"  # 设置保存模型路径
...
def validation(model, device, optimizer, test_loader):
    ...
    with open('meldatas3.txt', 'a', encoding='utf-8') as f:
        f.write(datas)
        f.write('\n')
        f.close()
...
if __name__ == '__main__':
    for epoch in range(epochs):
        ...
        np.save('./Mel-Spec-LSTM_training_losses.npy', A)
        np.save('./Mel-Spec-LSTM_training_scores.npy', B)
        np.save('./Mel-Spec-LSTM_test_loss.npy', C)
        np.save('./Mel-Spec-LSTM_test_score.npy', D)
