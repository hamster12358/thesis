...
save_model_path = './onlytrainconnect'
...
def validation(model, device, optimizer, test_loader, use_pretrained=False):
    ...
    with open('connectonly.txt', 'a', encoding='utf-8') as f:
        f.write(datas)
        f.write('\n')
        f.close()
...
if __name__ == '__main__':
    ...
    rnn_decoder.load_state_dict(torch.load(os.path.join(rnn_decoder_model_path, 'rnn_decoder_epoch100.pth')))
